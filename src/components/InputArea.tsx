          ...
          <div className="flex items-center gap-3">
            ...
            <div className="rounded-xl border border-[#ececff] bg-[#fafafe] px-1">
              <Select
                ...
                value={duration}
              >
                <SelectTrigger className="h-11 w-28 rounded-xl border-0 bg-transparent px-3 text-sm font-semibold text-[#5c6279] shadow-none focus:ring-0">
                  <SelectValue />
                </SelectTrigger>
            ...
            <ToggleGroup
              ...
              className="flex h-11 items-center rounded-xl border border-[#ececff] bg-[#fafafe] p-1 shadow-sm"
              aria-label="Aspect ratio"
            >
              <ToggleGroupItem
                value="16:9"
                aria-label="Landscape"
                className={`group flex h-9 items-center gap-2 rounded-lg px-4 text-sm font-semibold transition-all duration-200 ${
                  aspectRatio === "16:9"
                    ? "bg-linear-to-r from-[#7a56ff] to-[#946dff] text-white shadow-lg shadow-[#7a56ff]/20"
                    : "text-[#687086] hover:bg-white/70"
                }`}
              >
                <div
                  className={`h-4 w-6 rounded-sm border transition-all duration-200 ${
                    aspectRatio === "16:9"
                      ? "border-white/80"
                      : "border-[#b3b8cc]"
                  }`}
              ...
              >
                <div
                  className={`h-6 w-4 rounded-sm border transition-all duration-200 ${
                    aspectRatio === "9:16"
                      ? "border-white/80"
                      : "border-[#b3b8cc]"
                  }`}
